...
time.sleep(6)
driver.find_element_by_xpath('//*[@id="kO001e"]/header/nav/div/c-wiz/div/div/div[1]/button/img').click() #click on account icon  
time.sleep(4)
driver.find_element_by_css_selector("#kO001e > header > nav > div > c-wiz > div > div > div:nth-child(2) > div > ul > li:nth-child(15) > span.VfPpkd-StrnGf-rymPhb-b9t22c").click() #switch acc
time.sleep(3)
driver.find_element_by_css_selector("#view_container > div > div > div.pwWryf.bxPAYd > div > div.WEQkZc > div > form > span > section > div > div > div > div > ul > li.JDAKTe.eARute.W7Aapd.zpCp3.SmR8 > div > div > div.BHzsHc").click() #click on use another acc
time.sleep(4)
driver.find_element_by_name("identifier").send_keys("google@123@gmail.com") #replace with your email
time.sleep(3)
driver.find_element_by_css_selector("#identifierNext > div > button > span").click() #click on next
time.sleep(4)
driver.find_element_by_name("password").send_keys("google123@#@") #replace with your password
time.sleep(3)
driver.find_element_by_css_selector("#passwordNext > div > button > span").click() #click on next
time.sleep(9) 
driver.find_element_by_xpath('//*[@id="kO001e"]/header/nav/div/div[1]').click() #click on search icon
time.sleep(2)
search_box = driver.find_element_by_xpath('//*[@id="kO001e"]/header/nav/c-wiz/div/div/label/input') 
...
driver.find_element_by_css_selector('#yDmH0d > div.VfPpkd-Sx9Kwc.cC1eCc.UDxLd.PzCPDd.HQdjr.VfPpkd-Sx9Kwc-OWXEXe-FNFY6c > div.VfPpkd-wzTsW > div > div > div > div > div:nth-child(3) > div > div > div > button > span').click() #submit button
time.sleep(6)
#if you want more accs with ratings means copy from 39 to 51 fast acc switching...
